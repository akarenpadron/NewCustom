      ...
      <div class="row align-items-center justify-content-between d-flex">
        ...
        <nav id="nav-menu-container">
          <ul class="nav-menu">
            ...
            <li class="menu-active" style="background-color: rgba(255,255,255,0.05)"><a href="uniform4.php">DESIGN 4</a></li>
    ...
    <div class="container">
      <form id='contactus' action='<?php echo $formproc->GetSelfScript(); ?>' method='post' enctype="multipart/form-data" accept-charset='UTF-8'>
        <fieldset>
          ...
          <div><h2 align="center" style="margin-top:-10px"><input name="Design" id="design4" value="Design 4" type="hidden" /></h2>
          </div>
