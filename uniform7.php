      ...
      <div class="col-lg-6">
        <div align="center" style="margin:auto; height:850px; width:290px"><!--200-->
          ...
          <?php  
            ...
            $item_types=array('base','sho');
            $design_labels= array('Primary Color', '<br>Secondary Color', 'Main Color', '<br>Accent Color');
            foreach($colors as $color) echo "<div id='".$color."sho1a'><img id='".$color."imgsho1' src='assets/Uniforms/P4D1/SHORT/design".$design_number."-".$color."1.png'/></div> <div id='".$color."base1a'><img id='".$color."imgbase1' src='assets/Uniforms/P4D1/JERSEY/design".$design_number."-".$color."1.png'/></div>";
            foreach($colors as $color) echo "<div id='".$color."sho2a'><img id='".$color."imgsho2' src='assets/Uniforms/P4D1/SHORT/design".$design_number."-".$color."2.png'/></div> <div id='".$color."base2a'><img id='".$color."imgbase2' src='assets/Uniforms/P4D1/JERSEY/design".$design_number."-".$color."2.png'/></div>";
            foreach($s_colors as $color) echo "<div id='".$color."sock1a'><img id='".$color."imgsock1' src='assets/Uniforms/P4D1/SOCKS/design".$design_number."-".$color."1.png'/></div>";
          echo "</div>";
        echo "</div>";
        echo "<div class='col-lg-6 colors'>";
          for ($h = 0; $h <sizeof($item_types); $h++) {
