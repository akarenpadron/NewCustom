...
.custom-header {
  background-image: url("../img/BALL-BANNER-PAGE.jpg"); 
...
<div class="row d-flex justify-content-between" style="background-image: url(img/BALL-BANNER-PAGE3.jpg);width:100%;height:auto;background-size: 100% 100%;margin-right: 0px;margin-left: 0px;">
  ...
  <!-- PARALLAX TOP BANNER
  <div class="header-background" style="background-color:gray">
    ...
    <section class="col-xl-12 col-lg-12 custom-header" style="max-width:1500px;vertical-align: middle;top:50%;">
      <div class="col-lg-6 col-md-6 single-footer-widget float-right vertical-align" >
        <h1 style="color:black;">
          <br>
          SCORE<span style="font-size:25px;">®</span> Custom Ball Studio 
        </h1>
        <h3 style="color:black">Complete your league’s unique look with SCORE Pro custom balls. Brand your league with our premium quality, state-of-the-art soccer balls and set your league apart from the rest. </h3>
      </div>
...
<div class="row swatch" style="padding-top: 10%;">
  ...
  <div class="col-sm-6" class="ballImages">
    <div align="center" style="margin:auto; height:437px; width:290px;">
      ...
      <div id="d1-blk1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-blk1.png"/></div>
      <div id="d1-chr1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-chr1.png"/></div>
      <div id="d1-col1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-col1.png"/></div>
      <div id="d1-gld1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-gld1.png"/></div>
      <div id="d1-hun1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-hun1.png"/></div>
      <div id="d1-kel1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-kel1.png"/></div>
      <div id="d1-lem1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-lem1.png"/></div>
      <div id="d1-lim1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-lim1.png"/></div>
      <div id="d1-nav1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-nav1.png"/></div>
      <div id="d1-org1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-org1.png"/></div>
      <div id="d1-pur1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-pur1.png"/></div>
      <div id="d1-red1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-red1.png"/></div>
      <div id="d1-roy1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-roy1.png"/></div>
      <div id="d1-sil1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-sil1.png"/></div>
      <div id="d1-tur1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-tur1.png"/></div>
      <div id="d1-wht1"><img class="ballImages" src="assets/Balls/DESIGN1/design1-wht1.png"/></div>

      <div id="d1-blk2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-blk2.png"/></div>
      <div id="d1-chr2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-chr2.png"/></div>
      <div id="d1-col2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-col2.png"/></div>
      <div id="d1-gld2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-gld2.png"/></div>
      <div id="d1-hun2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-hun2.png"/></div>
      <div id="d1-kel2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-kel2.png"/></div>
      <div id="d1-lem2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-lem2.png"/></div>
      <div id="d1-lim2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-lim2.png"/></div>
      <div id="d1-nav2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-nav2.png"/></div>
      <div id="d1-org2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-org2.png"/></div>
      <div id="d1-pur2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-pur2.png"/></div>
      <div id="d1-red2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-red2.png"/></div>
      <div id="d1-roy2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-roy2.png"/></div>
      <div id="d1-sil2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-sil2.png"/></div>
      <div id="d1-tur2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-tur2.png"/></div>
      <div id="d1-wht2"><img class="ballImages" src="assets/Balls/DESIGN1/design1-wht2.png"/></div>
